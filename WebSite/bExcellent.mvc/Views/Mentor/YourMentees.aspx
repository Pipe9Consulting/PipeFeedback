...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <%--stylesheet--%>
    <link href="../../Styles/mentor/yourmentees.css" rel="stylesheet" type="text/css" />
    ...
    <script src="../../Scripts/ref/Mentor/YourMentees.js" type="text/javascript"></script>
    <%-- For Photo Upload--%>
    ...
    <input type="hidden" id="selectedPoeValueYourMentees" value="<%:t%>" />
    <input type="hidden" id="yourMenteesType" value="0" />
    <input type="hidden" id="selectedidyourmentee" />
                        ...
                        <div class="pageholder">
                            ...
                            <div id="customertiles">
                                ...
                                <div class="breadcrumb">
                                    <span class="net1"><a href="../Common/Index">Home </a>&gt; <a href="../Mentor/Mentor">Mentors </a>&gt;&nbsp Your Mentees</span> <span class="net2"><a href="../Common/Index">Home
                                ...
                                <div class="customertiles stars last urntwrk">
                                    ...
                                    <div class="network">
                                        <div class="networkholder">
                                            ...
                                            <div class="coltwo" id="yourmenteeslist">
