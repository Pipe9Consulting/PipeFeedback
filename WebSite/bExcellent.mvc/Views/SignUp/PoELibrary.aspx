    ...
    <form id="dnloadPDF">
            ...
            <div class="poepopupcontent">
                ...
                <div class="popupwrapper">
                    ...
                    <ul id="poeselection">
                        ...
                        <!-- commented to make the REPs free of cost -->
                        ...
                        <li id="addnowTrail">
                            <%--<li id="addnowTrail" value="Trail"><img src="../../Images/trial.png" alt="Trial" />--%><!-- commented to make the REPs free of cost -->
                            <img src="../../Images/icons/add-user_ico.png" alt="Business subscription">
                            <p>Trial for Free</p>
                            <span></span>
                        </li>
        ...
        <div class="byo">
            <div class="poepopup" id="anatomy" style="cursor: move">
                ...
                <div class="poepopupcontent">
                    <img src="../../Images/poe-anatomy-bg.jpg" />
                    <div class="popupwrapper">
                        <table border="0" cellspacing="0" cellpadding="5">
                            <tr>
                                ...
                                <td width="40%" colspan="2" class="popuptextbg aop">
                                    <p>
        ...
        <div class="poepage">
            <div class="placeholder">
                <div class="top_cont">
                    <div class="top poecolumn">

                        <h1>EXCELLENCE PROFILE LIBRARY</h1>
                        <%-- <div class="select">
                    ...
                    <div class="top midcolumn">
                        <h1>Spotlight</h1>
                    </div>
                    <div class="top poelastColumn">
                        <h1>YOUR PROFILES</h1>
                    </div>
                </div>
                <div class="poecolumn poemargintop">
                    ...
                    <ul id="microsoft" style="display: block;">
                        ...
                        <li id="poe22">
                            <img src="../../Images/KessakuImage/InsideSales.png" width="600" height="600" />
                            <p>
                                Inside Sales
                            </p>
                        </li>
                        ...
                        <li id="poe17">
                            <img src="../../Images/KessakuImage/IMDM.png" width="600" height="600" />
                            <p>
                                Industry Market Development Manager
                            </p>
                        </li>
                        <li id="poe16">
                            <img src="../../Images/KessakuImage/PartnerTechnologyStrategist.png" width="600" height="600" />
                            <p>
                                Partner Technology Strategist
                            </p>
                        </li>
                        <li id="poe15">
                            <img src="../../Images/KessakuImage/ChannelExecutive.png" width="600" height="600" />
                            <p>
                                Channel Executive
                            </p>
                        </li>
                    ...
                    <ul id="sales" style="display: none">
                ...
                <div class="midcolumn" id="poe-columnmarginfrist">
                    ...
                    <ul>
                        ...
                        <li id="poe17">
                            <img src="../../Images/KessakuImage/PoE/IndustryMarketDevelopmentManager_large.png" width="600" height="600" />
                            <p>
                                Industry Market Development Manager
                            </p>
                        </li>
