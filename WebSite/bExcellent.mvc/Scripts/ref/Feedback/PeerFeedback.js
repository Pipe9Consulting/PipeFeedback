var details_feedback = {
    ...
    loadModuleIds: function (option) {
        ...
        Common.ajax({
            ...
            success: function (response) {
                ...
                details_feedback.loadDetailViewPAQuestions({ url: '../../Feedback/GetQuestions', data: { 'moduleId': $('#module2').val() }, moduleorder: 2 });
                details_feedback.loadPoeContent({ url: '../../Feedback/GetPoeIntoContent' }, '#poeintro');
                details_feedback.loadPoeContent({ url: '../../Feedback/GetModuleIntoContent', data: { 'moduleId': 1} }, '#moduleintro');
                details_feedback.loadPoeContent({ url: '../../Feedback/GetModuleKeyAction', data: { 'moduleId': 1} }, '#modulekeyaction');
                details_feedback.loaddetailslider();
    ...
    loadCompletedPracticeArea: function (moduleid, moduleorder) {
        var loadedPA = $('#compltedPracticeArea').html();
        var newcompletedPA = '';
        ...
        $('#compltedPracticeArea').html(loadedPA + newcompletedPA);
    },
