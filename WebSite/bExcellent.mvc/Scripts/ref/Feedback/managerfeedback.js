            ...
            success: function (response) {
                ...
                for (var i = 0; i < response.length; i++) {
                    ...
                    var questionhtml = " <li id='q" + response[i].QuestionOrderNumber + "' class= '" + ((manager_feedback.userratingcount == 1) ? "questionContainer" : "questionratingContainer") + "' value=" + questaken + " " + (i < 5 ? "" : "style='display:none'") + "> <div class='questiontaken' >Action " + questaken + "/" + $('#totalQuestions').val() +
                        ...
                        "<p>" + sideBarContent.replace('<strong>', '').replace('</strong>', '').replace('<p>', '').replace('</p>', '').replace('In Detail:', '') + "</p></div><div class='clr'></div><div class='OverallScale'> <div class='importanceArea'><div class='slidercontent'><img src='../../Images/Feedback/Icon/importanceIcon.png'><h4>Importance Scale</h4><p>Select how important this Excellence Action is in your market</p></div></div>   <div class='capabilityArea'><div class='slidercontent'><img src='../../Images/Feedback/Icon/capabilityIcon.png'><h4>Capability Scale</h4><p>Select how ready your team member is to demonstrate this Excellence Action</p></div></div> <div class='frequencyArea'><div class='slidercontent'><img src='../../Images/Feedback/Icon/frequencyIcon.png'><h4>Frequency Scale</h4><p>Select how consistently your team member demonstrates this Excellence Action</p></div></div></div>";
