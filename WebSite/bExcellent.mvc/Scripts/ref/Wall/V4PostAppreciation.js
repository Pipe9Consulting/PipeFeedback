               ...
               // debugger;
                ...
                if (response != null) {
                    for (var i = 0; i < response.length; i++) {
                        html = html + "<li class='profileDetails' id='member" + response[i].UserId + "' value=" + response[i].User.UserId + ">" +
...
$(document).ready(function () {
    ...
    $('.close,.yammerOk').click(function () {
       //debugger;
        $('.poepopupbg,.popup').hide();
        $('#subject').val('');
        $('#appreciation').val('');
        $('#comments').val('');
        ...
        $('#award li').removeClass('selectbadge');
        $('#badge li').removeClass('selectbadge');
        $('.postcmnt li').removeClass('postsel');
        $('#fileadded').html('');
        $('.profileDetails').removeClass('selectProfile');
    ...
    $('#badge li').live('click', function () {
        ...
        $('#badge li').not($(this)).removeClass('selectbadge');
    });
    $('#award li').live('click', function () {
        $(this).toggleClass('selectbadge');
        $('#award li').not($(this)).removeClass('selectbadge');
    });
    ...
    $('.sendProfileList li').live('click', function () {
        ...
        var emailids = '';
        if ($('#selectedmembersemailids').val().indexOf($(this).find('p').html()) == -1) {
            emailids = $('#selectedmembersemailids').val() + $(this).find('p').html() + ';';
        } else {
            emailids = $('#selectedmembersemailids').val().replace($(this).find('p').html() + ';', '');
        }
        ...
        if (txtareavalText == "") {
           ...
           // alert('Please Enter the Text');
            ...
            if (selectedids.length <= 1) {
                ...
                var badge = $('#badge .selectbadge').val();
                var award = $('#award .selectbadge').val();
                var badgeText = '';
                var awardText = '';
                var subject = '';
    ...
    $('.sendAppreciation').addClass('selectSend');
    $('.wall2').show();
    $('div.wallleftMenu li.walltile').removeClass('selectWall');
    $('div.wallleftMenu li.postVideo').removeClass('selectPost');
