                    ...
                    for (var i = 0; i < response.length; i++) {
                        ...
                        if ($('#scaleMode').val() == 0) {
                            ...
                            html = html + "<ul><li class='qnumber' style='vertical-align: top;'>" + (i + 1) + "</li><li style='vertical-align: top;'><span class='modNmaeview'>" + response[i].ModuleName + "</span></li> " +
                                ...
                                "<li class='" + selected4 + "'>Always " + selectedRole4 + "</li> </ul></div><div class='dp_capab'><ul class='capability_scale'> <li class='" + capselected1 + "'>Introductory " + capselectedRole1 + "</li> <li class='" + capselected2 + "'>Intermediate " + capselectedRole2 + "</li> <li class='" + capselected3 + "'>Experienced " + capselectedRole3 + "</li> " +
                                "<li class='" + capselected4 + "'>Expert " + capselectedRole4 + "</li> </ul></div><div class='dp_importnt'><ul class='important_scale'> <li class='" + impselected1 + "'>Not important " + impselectedRole1 + "</li> <li class='" + impselected2 + "'>Somewhat Important " + impselectedRole2 + "</li> <li class='" + impselected3 + "'>Important " + impselectedRole3 + "</li> " +
                            ...
                            html = html + "<ul><li class='qnumber' style='vertical-align: top;'>" + (i + 1) + "</li><li style='vertical-align: top;'><span class='modNmaeview'>" + response[i].ModuleName + "</span></li> " +
                                "<li><div class='qncontent'>" + moreText + "<div class='hover_content' style='display:none'> " + response[i].Question + " <span> <img src='../../Images/start/hover_arrow.png' /></span> </div></div><div class='clr'></div><div class='dp_fci'><div class='dp_freq'><ul class='frequency_scale'> <li class='" + selected1 + "'>Never " + selectedRole1 + "</li> <li class='" + selected2 + "'>Sometimes " + selectedRole2 + "</li> <li class='" + selected3 + "'>frequently " + selectedRole3 + "</li> " +
                                "<li class='" + selected4 + "'>Always " + selectedRole4 + "</li> </ul></div><div class='dp_capab'><ul class='capability_scale'> <li class='selectYou'>Introductory<span class='youSpan'>Manager</span></li> <li class='selectManager'>Introductory <span class='managerSpan'>You</span></li> <li class=''>Experienced</li> " +
                                "<li class=''>Expert</li> </ul></div><div class='dp_importnt'><ul class='important_scale'> <li class='selectYou'>Not important <span class='youSpan'>Manager</span></li> <li class='selectManager'>Somewhat Important <span class='managerSpan'>You</span></li> <li class=''>Important</li> " +
