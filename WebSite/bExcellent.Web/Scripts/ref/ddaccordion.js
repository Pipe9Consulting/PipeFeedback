ddaccordion.init({
	...
	togglehtml: ["suffix", "<img src='images/down-arrow.png' class='statusicon' />", "<img src='images/down-up.png' class='statusicon' />"], //Additional HTML added to the header when it's collapsed and expanded, respectively  ["position", "html1", "html2"] (see docs)
...
$(document).ready(function () {
    $('#pollSlider-button').click(function () {
        if ($(this).css("margin-right") == "340px") {
            $('.pollSlider').animate({ "margin-right": '-=340' });
            $('#pollSlider-button').animate({ "margin-right": '-=340' });
        }
        else {
            $('.pollSlider').animate({ "margin-right": '+=340' });
            $('#pollSlider-button').animate({ "margin-right": '+=340' });
...
$(document).ready(function () {
    $('#pollSliderleft-button').click(function () {
        if ($(this).css("margin-left") == "340px") {
            $('.pollSliderleft').animate({ "margin-left": '-=340' });
            $('#pollSliderleft-button').animate({ "margin-left": '-=340' });
        }
        else {
            $('.pollSliderleft').animate({ "margin-left": '+=340' });
            $('#pollSliderleft-button').animate({ "margin-left": '+=340' });
