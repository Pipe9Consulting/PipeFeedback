var Slider = new Class({
    ...
    setMin: function (stepMin) {
        ...
        this.bkg.style.clip = "rect(0px " + (parseInt(this.toPosition(this.step)) + 3) + "px 80px 0px)";
    ...
    setMax: function (stepMax) {
        ...
        this.bkg.style.clip = "rect(0px " + r + "px 20px " + this.clip_l + "px)";
    ...
    checkStep: function (mx) {
        ...
        if (this.maxknob != null) {
            ...
            var r = parseInt(this.clip_l + w);
            this.bkg.style.clip = "rect(0px " + r + "px 80px " + this.clip_l + "px)"
            //status =this.bkg.style.clip  + " w= " + w //Debug

        } else {
            this.fireEvent('onChange', this.step);
            this.bkg.style.clip = "rect(0px " + (parseInt(this.drag.value.now[this.z]) + 3) + "px 80px 0px)"
