...
{
    partial class KessakuDemoNotificationService : ServiceBase
    {
        private static IScheduler _scheduler;

        public KessakuDemoNotificationService()
        {
        ...
        public void AddJobs()
        {
            ...
            var PlanNotificationJobDetail = new JobDetailImpl("kessakuDemoPlanNotificationJob", "kessakuDemoPlanNotificationGroup", PlanNotificationJob.GetType());
            var PlanNotificationtrigger = new CronTriggerImpl("kessakuDemoPlanNotificationTrigger", "kessakuDemoPlanNotificationGroup", cronExpPlan);
            ...
            var YammerNotificationJobDetail = new JobDetailImpl("kessakuDemoYammerNotificationJob", "kessakuDemoYammerNotificationGroup", YammerNotificationJob.GetType());
            var YammerNotificationtrigger = new CronTriggerImpl("kessakuDemoYammerNotificationTrigger", "kessakuDemoYammerNotificationGroup", cronExpyammer);
