...
namespace KessakuYammerNotification
{
    public partial class KessakuYammerNotifications : ServiceBase
    {
        private static IScheduler _scheduler;
        public KessakuYammerNotifications()
        {
            InitializeComponent();
        }
        ...
        {
            //plan notifcation
            const string cronExpyammer = "0 0/4 * * * ?";// " 0 0/1 * 1/1 * ? *  ";
